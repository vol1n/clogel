(ns vol1n.clogel.core
  (:require [vol1n.clogel.scalar :refer [clogel-scalars]]
            [vol1n.clogel.cast :refer [defgelcasts gelcast-registry]]
            [vol1n.clogel.collection :refer [clogel-collections]]
            [vol1n.clogel.object-util :refer []]
            [vol1n.clogel.functions-operators :refer
             [gelfunc-registry gelop-registry defgelfuncs defgeloperators gel-index]]
            [vol1n.clogel.functions-operators :as func]
            [vol1n.clogel.object-types :refer [defgelobjects dot-access gelobject-registry]]
...
(comment
  ...
  (println (clogel->edgeql (-> (top/insert {:User [{:= {:name "Colin"}}
